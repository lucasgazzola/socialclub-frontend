...
const modulos = [
  {
    titulo: 'Socios',
    description: 'Alta, edición, baja y consulta de socios del club.',
    icon: Users,
  },
  {
    titulo: 'Usuarios',
    description: 'Gestión de usuarios administrativos y sus roles.',
    icon: ShieldCheck,
  },
  {
    titulo: 'Auditoría',
    description: 'Registro inalterable de todas las operaciones del sistema.',
    icon: ScrollText,
  },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {modulos.map(({ titulo, description, icon: Icon }) => (
